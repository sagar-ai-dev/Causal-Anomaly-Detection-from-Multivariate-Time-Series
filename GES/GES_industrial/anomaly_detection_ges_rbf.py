"""
==============================================================
 Causal Discovery & Anomaly Detection (GES RBF - TEP)
==============================================================
Author: (Sagar)
"""
...
def learn_causal_model(normal_csv_path: str, save_path: str):
    ...
    # Strict DAG enforcement: causal-learn encodes i -> j as adj[i,j] == -1 with adj[j,i] == 1.
    # The raw matrix also contains undirected (-1/-1) and bidirected (1/1) edges, which are not
    # causal parents and create mutual-dependency cycles if regressed on.
...
def main():
    ...
    err_eval, _ = compute_windowed_errors(
        normal_test, window_len, fine_coeffs, normal_matrix, indices, rbf_maps)
