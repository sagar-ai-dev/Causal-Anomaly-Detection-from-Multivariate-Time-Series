"""
==============================================================
 Causal Discovery & Anomaly Detection (GES Linear - Healthcare)
==============================================================
Author: (Sagar)
"""
...
def main():
    ...
    err_eval, _ = compute_windowed_errors(
        held_out, window_len, fine_coeffs, normal_matrix, indices, scale_maps)
    ...
    for attack_name, attack_data in zip(attack_names, attack_data_list):
        ...
        err_attack, norm_agg_attack = compute_online_errors(
            attack_data, fine_coeffs, normal_matrix, indices, scale_maps)
